...
import hu.cubix.hr.bognarlili.dto.CompanyDto;
import hu.cubix.hr.bognarlili.dto.EmployeeDto;
import hu.cubix.hr.bognarlili.dto.Views;
...
//		} else {
//			return companies.values().stream().map(
//					c -> createCompanyWithoutEmployees(c))
//			.toList();
//		}
//	}
//	
...
//			: companies.values().stream().map(this::createCompanyWithoutEmployees).toList();
//	
	
	//2. MO: JSON view annotation
