...
public class HrApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Employee e1 = new Employee(1L, "dev", 100_000, LocalDateTime.now().minusYears(11));
	    Employee e2 = new Employee(2L, "dev", 100_000, LocalDateTime.now().minusYears(6));
	    Employee e3 = new Employee(3L, "dev", 100_000, LocalDateTime.now().minusYears(3));
	    Employee e4 = new Employee(4L, "dev", 100_000, LocalDateTime.now().minusYears(1));
